...
// páginas que existen a propósito fuera del índice: no llevan canonical
// ni entran en el sitemap. El resto de comprobaciones sí se les aplica.
const SIN_INDEXAR = new Set(['404.html']);
const errores = [];
const avisos = [];
...
for (const p of paginas) {
  ...
  todos(html, /href="((?!https?:|tel:|mailto:|#|data:)[^"]+)"/g).forEach(href => {
    // fuera el ancla y la versión de caché (styles.css?v=1) antes de buscar el archivo
